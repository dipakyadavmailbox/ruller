...
export default function CalorieCalculator() {
  usePageMeta({
    title: 'Calorie Calculator — Free TDEE & Macro Calculator',
    description: 'Calculate your daily calorie needs (TDEE) and a suggested macro split using the Mifflin-St Jeor equation. Supports metric and imperial units.',
  })
  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '32px 20px 60px' }}>
      ...
      <p style={{ color: 'var(--ink-dim)', fontSize: 14, lineHeight: 1.6, marginBottom: 28 }}>
        Uses the Mifflin-St Jeor equation to estimate your daily calorie
        needs, then applies your goal and shows a macro split.
      </p>
